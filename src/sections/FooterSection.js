			...
			<form className="mt-4 space-y-4 sm:max-w-xs">
				<fieldset className="w-full">
					...
					<div className="relative">
						<select id="language" className="appearance-none block w-full bg-white border border-gray-300 rounded-md py-2 pl-3 pr-10 text-base leading-6 text-gray-900 focus:outline-none focus:shadow-outline-blue focus:border-blue-300 sm:text-sm sm:leading-5">
						...
						<div className="pointer-events-none absolute inset-y-0 right-0 px-2 flex items-center" aria-hidden="true">
				...
				<fieldset className="w-full">
					...
					<div className="relative">
						<select id="currency" className="appearance-none block w-full bg-white border border-gray-300 rounded-md py-2 pl-3 pr-10 text-base leading-6 text-gray-900 focus:outline-none focus:shadow-outline-blue focus:border-blue-300 sm:text-sm sm:leading-5">
							<option>ARS</option>
